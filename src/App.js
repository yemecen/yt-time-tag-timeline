      ...
      <div className="row position-relative">
        <div className="col-md-5 g-4 position-absolute top-0 start-50 translate-middle">
          <div className="input-group mb-2">
            <input type="text" id="search" className="form-control" placeholder="Video link or word search..." aria-label="Search" aria-describedby="basic-addon1" onClick={onClick} />
          </div>
        </div>
      </div>
